...
classes = 3755
batch_size = 64
check_pointer = ModelCheckpoint(filepath='models/Geetest/model_inception_resnet_v2/best_model.hdf5',
...
base_model = tf.keras.applications.InceptionResNetV2(include_top=True, weights=None, classes=classes,
                                                     input_shape=shape,
                                                     )
model = base_model
...
model.summary()
history = model.fit(x=train_data.get_mini_batch(), steps_per_epe=steps_per_epoch, epochs=50,
                    validation_data=val_data.get_mini_batch(),
                    validation_steps=val_step, callbacks=callback_list)

model.save('models/Geetest/model_inception_resnet_v2/final_model.hdf5')

loss_trend_graph_path = "models/Geetest/model_inception_resnet_v2/_loss.jpg"
acc_trend_graph_path = "models/Geetest/model_inception_resnet_v2/_acc.jpg"
fig = plt.figure(1)
