...
classes = 3755
batch_size = 16
check_pointer = ModelCheckpoint(filepath='models/Geetest/model_resnet_50/best_model.hdf5',
...
base_model = keras.applications.ResNet50(include_top=False, weights=None, classes=classes,
                                         input_shape=shape,
                                         )
inp = Input(shape)
x = base_model(inp)
...
model.save('models/Geetest/model_resnet_50/final_model.hdf5')

loss_trend_graph_path = "models/Geetest/model_resnet_50/_loss.jpg"
acc_trend_graph_path = "models/Geetest/model_resnet_50/_acc.jpg"
fig = plt.figure(1)
